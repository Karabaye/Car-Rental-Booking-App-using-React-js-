...
const CarCard = ({ car }) => {
  ...
  return (
    <div onClick={() => {navigate(`/car-details/${car._id}`); scrollTo(0, 0)}}
     className='group rounded-xl overflow-x-hidden shadow-lg hover:translate-y-[-2px] transition-y-1
     transition-all duration-500 cursor-pointer'>
        ...
        <div className='absolute bottom-4 right-4 bg-black/80 backdrop-blur-sm text-white px-3 py-2 rounded-lg'>
          <span className='text-sm font-semibold'>{currency}{car.pricePerDay}</span>

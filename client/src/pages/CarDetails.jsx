       ...
       <div className='grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12'>
          ...
          <div className='space-y-6'>
            ...
            <div>
              ...
              <ul className='grid grid-cols-1 sm:grid-cols-2 gap-2'>
                {(car.features || ["360° Camera", "Bluetooth", "GPS", "Sunroof", "Heated Seats", "Rear View Mirror"]).map((item) => (
                  <li key={item} className='flex items-center text-gray-500'>
                    <img src={assets.check_icon} className='h-4 mr-2' alt="Feature check" />
                    {item}
                  </li>
                ))}
              </ul>
        ...
        <form onSubmit={handleSubmit} className='shadow-lg h-max sticky top-18 rounded-xl p-6 space-y-6 text-gray-500'>
          ...
          <p className='flex items-center justify-between text-2xl text-gray-800
           ...
           transition-all font-medium text-white py-3 rounded-xl cursor-pointer'>Book Now</button>

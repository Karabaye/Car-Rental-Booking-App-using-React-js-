...
const Dashboard = () => {
  ...
  return (
    <div className='px-4 pt-10 md:px-10 flex-1'>
      ...
      bookings, revenue, and recent activity" />
      ...
      <div className='flex flex-wrap items-start gap-6 mb-8 w-full'>
        ...
        <div className='p-4 md:p-6 border border-borderColor rounded-md max-w-lg w-full'>
            ...
            <p className='text-sm text-gray-500'>Last customer bookings</p>
        ...
        <div className='p-4 md:p-6 mb-6 border border-borderColor rounded-md md:max-w-xs w-full'>
            ...
            <p className='text-sm text-gray-500'>Total revenue generated this month</p>
